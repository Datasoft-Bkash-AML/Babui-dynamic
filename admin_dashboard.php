    ...
    <table class="table table-bordered bg-white shadow-sm">
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    <a href="/admin_product_form.php?id=<?= $product['_id'] ?>" class="btn btn-sm btn-primary">Edit</a>
                    <a href="/admin_delete_product.php?id=<?= $product['_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this product?')">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
