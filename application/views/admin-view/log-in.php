...
<head>
	...
	<meta charset="utf-8" />
	<title>Login | Tocly - Admin & Dashboard Template</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
	<meta content="Themesdesign" name="author" />

	<?php $this->load->view('admin-view/links'); ?>
					...
					<div class="w-100">
						<div class="d-flex flex-column h-100 py-0 py-xl-3">
									...
									<div class="col-lg-6">
										<div class="p-lg-5 p-4">
											<div>
												...
												<form action="http://localhost/babui/index.php/adlogin/authenticate" class="auth-input" method="post">
													<div class="mb-2">
							...
							<div class="mt-5 text-center">
								<p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Tocly. Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesdesign</p>
							</div>
						</div>
					</div>
				</div>
